  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-8 shadow-inner">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <div className="flex items-center">
                  ...
                  <span className="font-bold text-lg">Pokédex App</span>
                </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-700 text-center text-sm text-gray-500">
              <p>Pokémon data provided by the Pokémon API</p>
              <p className="mt-2">© {new Date().getFullYear()} Pokédex App. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </body>
